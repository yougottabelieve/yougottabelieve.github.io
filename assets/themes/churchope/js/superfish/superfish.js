(function(a) {
    a.superfish = {}, a.superfish.o = [], a.superfish.op = {}, a.superfish.defaults = {
        hoverClass: "sfHover",
        ...
        var c = "sfbreadcrumb",
            d = function() {
                var b = a(this),
                    c = f(b);
                g(c, !0), clearTimeout(c.sfTimer), b.showSuperfishUl().siblings().hideSuperfishUl()
            },
            e = function() {
                var b = a(this),
                    e = f(b),
                    h = g(e, !0);
                clearTimeout(e.sfTimer), b.is("." + c) || (e.sfTimer = setTimeout(function() {
        ...
        return this.each(function() {
            ...
            g.$path = a("li." + g.pathClass, this).each(function() {
                a(this).addClass(g.hoverClass + " " + c).filter(h()).removeClass(g.pathClass)
            }), a.superfish.o[f] = a.superfish.op = g, a(h(), this)[a.fn.hoverIntent && !g.disableHI ? "hoverIntent" : "hover"](d, e).not("." + c).hideSuperfishUl();
            var i = a("a", this);
            i.each(function(a) {
                var b = i.eq(a).parents("li");
                i.eq(a).focus(function() {
                    d.call(b)
                }).blur(function() {
                    e.call(b)
                })
        ...
        hideSuperfishUl: function() {
            var b = a.superfish.op,
                c = a("li." + b.hoverClass, this).add(this).removeClass(b.hoverClass).find(">ul").hide().css("visibility", "hidden");
            b.onHide.call(c);
            return this
        },
        showSuperfishUl: function() {
            var b = a.superfish.op,
                c = this.addClass(b.hoverClass).find(">ul:hidden").css("visibility", "visible");
            b.onBeforeShow.call(c), c.animate(b.animation, b.speed, function() {
                b.onShow.call(this)
            });
            return this
        }
        ...
        a("ul.superfish").each(function() {
            a("li", this).unbind("mouseover", "mouseout", "mouseenter", "mouseleave")
        })
    })
})(jQuery);
(function(a) {
        ...
        a.fn.bgIframe = a.fn.bgiframe = function(b) {
            if (a.browser.msie && /6.0/.test(navigator.userAgent)) {
                ...
                var c = function(a) {
                    ...
                    d = '<iframe class="bgiframe"frameborder="0"tabindex="-1"src="' + b.src + '"' + 'style="display:block;position:absolute;z-index:-1;' + (b.opacity !== !1 ? "filter:Alpha(Opacity='0');" : "") + "top:" + (b.top == "auto" ? "expression(((parseInt(this.parentNode.currentStyle.borderTopWidth)||0)*-1)+'px')" : c(b.top)) + ";" + "left:" + (b.left == "auto" ? "expression(((parseInt(this.parentNode.currentStyle.borderLeftWidth)||0)*-1)+'px')" : c(b.left)) + ";" + "width:" + (b.width == "auto" ? "expression(this.parentNode.offsetWidth+'px')" : c(b.width)) + ";" + "height:" + (b.height == "auto" ? "expression(this.parentNode.offsetHeight+'px')" : c(b.height)) + ";" + '"/>';
                return this.each(function() {
                    a("> iframe.bgiframe", this).length == 0 && this.insertBefore(document.createElement(d), this.firstChild)
                })
            }
            return this
        }
    })(jQuery), a.fn.hoverIntent = function(b, c) {
        var d = {
            sensitivity: 7,
            interval: 100,
            timeout: 0
...
(function(a) {
    a.fn.supposition = function() {
        var b = a(window),
            c = function(a) {
                return window[a == "y" ? "pageYOffset" : "pageXOffset"] || document.documentElement && document.documentElement[a == "y" ? "scrollTop" : "scrollLeft"] || document.body[a == "y" ? "scrollTop" : "scrollLeft"]
            },
            d = function() {
                $topNav = a("li", this);
            ...
            f = function() {
                this.each(function() {
                    ...
                    }(d.parents('.sub-menu').hasClass('sfRight') || h > g) && (d.css("margin-left", (d.parents("ul").length == 1 ? g - h : -(e + f) + 26) + "px"), d.addClass("sfRight"), d.closest("li").closest("ul").addClass("sfRight")), d.css("display", "none")
                })
            };
        return this.each(function() {
